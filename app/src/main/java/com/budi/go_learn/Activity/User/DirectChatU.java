...
import com.budi.go_learn.Adapter.IsiChatUAdapter;
...
public class DirectChatU extends AppCompatActivity {
    ...
    private IsiChatUAdapter chatAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_direct_chat_u);
        ...
        chatAdapter = new IsiChatUAdapter(this, listChat);
