...
public class ChangePasswordU extends AppCompatActivity {
    private static final String TAG = ChangePasswordU.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_change_password_u);
